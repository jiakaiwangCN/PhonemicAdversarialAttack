...
from model.deepspeech.train_config import SpectConfig, BiDirectionalConfig, OptimConfig, AdamConfig, \
    SGDConfig
from model.deepspeech.decoder import GreedyDecoder
...
class DeepSpeech(nn.Module):
    def __init__(self,
        ...
        if 'BiDirectionalConfig' in OmegaConf.get_type(model_cfg).__name__:
